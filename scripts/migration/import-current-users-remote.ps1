...
#   .\scripts\migration\import-current-users-remote.ps1 -ConfirmProductionImport
...
Require-MigrationCommand "pg_dump"
...
Write-MigrationStep "Validated remote users import settings"
...
psql $SourceDbUrl -c "select count(*) as old_auth_users from auth.users;"
