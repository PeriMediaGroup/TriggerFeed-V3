-- =========================================================
-- 169: Add post/report context to moderation warning notifications
-- =========================================================
...
begin
  ...
  if v_post_excerpt is not null and char_length(v_post_excerpt) > 180 then
    v_post_excerpt := trim(left(v_post_excerpt, 180)) || '...';
  end if;
  ...
  values (
    ...
    null,
    'moderation_warning',
    case when v_post_available then p_related_post_id else null end,
    'Moderation warning',
    ...
    jsonb_strip_nulls(jsonb_build_object(
      ...
      'post_excerpt', coalesce(v_post_title, v_post_excerpt),
